...
export default function CustomerTable({ paginatedSuppliers, openEditModal, handleDelete }: { paginatedSuppliers: CustomerType[], openEditModal: (customer: CustomerType) => void, handleDelete: (id: string) => void }) {
        ...
        <div className="overflow-x-auto rounded-xl border border-slate-800">
            <table className="min-w-[900px] w-full text-sm">
                ...
                <tbody>
                    ...
                    {paginatedSuppliers.map((customer,i) => (
                        <tr
                            key={i}
                        ...
                        >
                            ...
                            <td className="p-3  text-center flex items-center justify-center space-x-3">
                                ...
                                {customer._id && <DeleteButton id={customer._id} />}
