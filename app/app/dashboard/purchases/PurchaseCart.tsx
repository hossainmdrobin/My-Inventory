...
import { decreamentQty, increamentQty, removeItem, setPaid, setQty } from "@/redux/slices/purchase/reducer.purchase";
import { X } from "lucide-react";
import { PurchaseType } from "@/types/purchase";

export default function PurchaseCart({ selectedIds, purchase }: { selectedIds: string[], purchase: PurchaseType }) {
