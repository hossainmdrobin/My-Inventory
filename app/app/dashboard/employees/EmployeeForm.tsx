...
export default function CreateEmployee({ editing, form, setForm, setOpen, handleSubmit }: { editing: any, form: any, setForm: any, setOpen: any, handleSubmit: any }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="w-full max-w-md rounded-xl bg-slate-900 p-6 space-y-4">
                ...
                >
                    <option value="seller">Role(By Default Seller)</option>
